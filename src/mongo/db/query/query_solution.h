...
struct IndexKeyNode : public QuerySolutionNode {
    IndexKeyNode(std::unique_ptr<QuerySolutionNode> child,
...
struct ProjectionNodeCovered final : ProjectionNode {
    ProjectionNodeCovered(std::unique_ptr<QuerySolutionNode> child,
        ...
        : ProjectionNode(std::move(child), fullExpression, projection, std::move(proj)),
