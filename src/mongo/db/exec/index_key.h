 ...
 * empty documents.
 *
 * If 'sortKeyMetaFields' array is specified while constructing this stage, each element in this
 ...
 */
class IndexKeyStage : public PlanStage {
public:
    static constexpr StringData kStageName = "INDEX_KEY"_sd;

    IndexKeyStage(OperationContext* opCtx,
...
private:
    ...
    // This stage specific stats.
    IndexKeyStats _specificStats;
