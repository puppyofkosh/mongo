 ...
 * zip
 */
class ZipStage final : public PlanStage {
public:
    /**
     ...
     */
    ZipStage(std::vector<std::unique_ptr<PlanStage>> inputStages,
             std::vector<value::SlotVector> outSlots,
...
private:
    const std::vector<value::SlotVector> _outSlots;
};
}  // namespace mongo::sbe
