...
TEST_F(SetNodeTest, ApplyNoOp) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("a")));
    addIndexedPath("a");
...
TEST_F(SetNodeTest, ApplyPositional) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.1")));
    setMatchedField("1");
    addIndexedPath("a");
...
TEST_F(SetNodeTest, ApplyNoOpDottedPath) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.b")));
    addIndexedPath("a.b");
...
TEST_F(SetNodeTest, ApplyNoOpArrayIndex) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.2.b")));
...
TEST_F(SetNodeTest, ApplyNumericField) {
    ...
    setPathTaken(PathTaken(FieldRef("a.2.b"), {FieldComponentType::kFieldName,
                    FieldComponentType::kFieldName, FieldComponentType::kFieldName}
                    ));
    addIndexedPath("a.2.b");
    auto result = node.apply(getApplyParams(doc.root()["a"]["2"]["b"]), getUpdateNodeApplyParams());
    ASSERT_FALSE(result.noop);
...
TEST_F(SetNodeTest, ApplyExtendNumericField) {
    ...
    setPathToCreate("b");
    setPathTaken(PathTaken(FieldRef("a.2"),
                           {FieldComponentType::kFieldName, FieldComponentType::kFieldName}));
    addIndexedPath("a.2.b");
...
TEST_F(SetNodeTest, ApplyNoOpComplex) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.1.b")));
...
TEST_F(SetNodeTest, NestedFieldFromReplication) {
    ...
    setPathToCreate("1.b");
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.a")));
...
TEST_F(SetNodeTest, DoubleNestedFieldFromReplication) {
    ...
    setPathToCreate("d");
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.b.c")));
...
TEST_F(SetNodeTest, ReplayArrayFieldNotAppendedIntermediateFromReplication) {
    ...
    setPathToCreate("b");
    setPathTaken(pathTakenFromFieldRef(FieldRef("a.0")));
    addIndexedPath("a.1.b");
    setFromOplogApplication(true);
...
TEST_F(SetNodeTest, Set6) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("r.a")));
    addIndexedPath("r.a");
...
TEST_F(SetNodeTest, ApplySetModToEphemeralDocument) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("x")));
    addIndexedPath("x");
