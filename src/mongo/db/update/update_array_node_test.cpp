...
TEST_F(UpdateArrayNodeTest, UpdateIsAppliedToAllMatchingElements) {
    ...
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [2, 1, 2]}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [2, 1, 2]}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, UpdateForEmptyIdentifierIsAppliedToAllArrayElements) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [1, 1, 1]}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [1, 1, 1]}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, ApplyMultipleUpdatesToArrayElement) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b': 1, 'a.0.c': 1, 'a.0.d': 1}}"),
                          getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b': 1, 'a.0.c': 1, 'a.0.d': 1}}"),
                          getOplogEntry());
...
TEST_F(UpdateArrayNodeTest, ApplyMultipleUpdatesToArrayElementsUsingMergedChildrenCache) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [{b: 1, c: 1}, {b: 1, c: 1}]}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [{b: 1, c: 1}, {b: 1, c: 1}]}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, ApplyMultipleUpdatesToArrayElementsWithoutMergedChildrenCache) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [{b: 2, c: 2, d: 1}, {b: 1, c: 2, d: 2}]}}"),
                          getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [{b: 2, c: 2, d: 1}, {b: 1, c: 2, d: 2}]}}"),
                          getOplogEntry());
...
TEST_F(UpdateArrayNodeTest, ApplyMultipleUpdatesToArrayElementWithEmptyIdentifiers) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b': 1, 'a.0.c': 1}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b': 1, 'a.0.c': 1}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, ApplyNestedArrayUpdates) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b.0.c': 1, 'a.0.b.0.d': 1}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b.0.c': 1, 'a.0.b.0.d': 1}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, NoArrayElementAffectsIndexes) {
    ...
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [{c: 0, b: 0}, {c: 0, b: 0}, {c: 0, b: 0}]}}"),
                          getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {a: [{c: 0, b: 0}, {c: 0, b: 0}, {c: 0, b: 0}]}}"),
                          getOplogEntry());
...
TEST_F(UpdateArrayNodeTest, WhenOneElementIsMatchedLogElementUpdateDirectly) {
    ...
    ASSERT_FALSE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.1.b': 0}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.1.b': 0}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, WhenOneElementIsModifiedLogElement) {
    ...
    ASSERT_FALSE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.1': {c: 0, b: 0}}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.1': {c: 0, b: 0}}}"), getOplogEntry());
    }
...
TEST_F(UpdateArrayNodeTest, ApplyPositionalInsideArrayUpdate) {
    ...
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
    if (v2LogBuilderUsed()) {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b.1': 1}}"), getOplogEntry());
    } else {
        ASSERT_BSONOBJ_EQ(fromjson("{$set: {'a.0.b.1': 1}}"), getOplogEntry());
    }
