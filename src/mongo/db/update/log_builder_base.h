 ...
 * methods for logging updates, creations and deletes.
 */
class LogBuilderBase {
public:
    /**
     * Methods for logging modifications to a document. The caller is expected to make
     * sure all of the paths provided are valid. For example, a sequence of calls which
     * updates field 'a' to the value "foo" and then attempts to update field 'a.b' is a
     * programming error.
     */
