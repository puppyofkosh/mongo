...
TEST_F(PullNodeTest, DocumentationExample1) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("flags")));
    addIndexedPath("a");
...
TEST_F(PullNodeTest, DocumentationExample2a) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("votes")));
    addIndexedPath("a");
...
TEST_F(PullNodeTest, CannotModifyImmutableField) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("_id.a")));
...
TEST_F(PullNodeTest, SERVER_3988) {
    ...
    setPathTaken(pathTakenFromFieldRef(FieldRef("y")));
    addIndexedPath("a");
